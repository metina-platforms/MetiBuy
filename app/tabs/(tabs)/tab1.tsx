    ...
    <Box className="flex-1 bg-gray-50 dark:bg-black">
        ...
        ListHeaderComponent={() => (
          <HStack className="bg-white p-1.5 rounded-md w-full mx-auto items-center ">
            ...
            <Box className="p-4">
              ...
              <Text className="text-gray-500">You have {products.length} items in your cart.</Text>
            </Box>
      ...
      <Center className="bg-white flex ">
        <HStack className="p-4 rounded-md w-[95%] mx-auto my-2">
          ...
          <Text className="ml-auto text-lg font-bold"> {currencyFormatter(products.reduce((acc, item) => acc + item.price, 0))}</Text>
        </HStack>
